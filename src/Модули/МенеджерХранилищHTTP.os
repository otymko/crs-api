...
Функция НовоеХранилище1C(Знач Адрес, Знач ИмяХранилища, Знач ВерсияПлатформы, Знач ИмяПользователя, Знач ПарольПользователя) Экспорт

	ХешПароляПользвателя = Вспомогательный.ХешированныйПароль(ПарольПользователя);
	...
	ПараметрыТелаЗапроса.Вставить("ХешПароляПользвателя", ХешПароляПользвателя);
