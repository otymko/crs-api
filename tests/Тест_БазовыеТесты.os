...
Процедура ПроверитьСозданиеХранилища() Экспорт
	...
	Попытка
		Результат = МенеджерХранилищHTTP.НовоеХранилище1C(АдресХранилища, ИмяХранилища, ВерсияПлатформы, 
...
Процедура ПроверкаПодключения() Экспорт
	...
	МенеджерХранилища = Новый МенеджерХранилищаHTTP(АдресХранилища, ВерсияПлатформы);
...
Процедура Инициализация()
	...
	ИмяХранилища = "newrepo" + (Новый УникальныйИдентификатор());
